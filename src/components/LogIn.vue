<template>
    ...
    <div id="content">
            <img class="vector" src="../assets/Vector.png" alt="kys" />
            <img class="logo" src="../assets/STAGY.png" alt="logo" />
            <p class="already">Vous n'avez pas encore de compte? <router-link to="/SignUp">SignUp</router-link></p>
        </div>
    <div class="registerl">
        ...
        <label for="input"  class="text">Mot de Passe:</label>
        <input type="password" id="password" v-model="password" required />
        <p v-if="err">{{ err }}</p>

        <p class="forgot"><router-link to="/forgot">mot de passe oublié ?</router-link></p>
    </div>
    <button id="sign" @click="register">Log In</button>
    <p id="continue">Ou continuez avec</p>
            ...
            .catch((error) => {
              ...
              switch (error.code) {
                ...
                case "auth/user-not-found":
                  err.value = "No account with that email was found";
                ...
                case "auth/user-disabled":
                  err.value = "no sadok allowed";
                  break;

                default:
                  err.value = "Email or password are incorrect";
    ...
    #content .already {
        position: absolute;
        top: 510px; /* Adjust the top position to place it under the logo */
        left: 50%; 
        transform: translateX(-50%);
        font-size: 13px;
        color: black;
    ...
    .registerl {
        position: absolute;
        top: 200px !important; /* Adjust the top position as needed */
        right: 400px;
        width: 200px;
        margin-bottom:20px;
    }
...
.registerl select {
    ...
    margin-right:250px;
    width:200px; /* Adjust font size as needed */
    color: #003F66; /* Adjust color as needed */
}
